...
;\details Aquí vamos a definir los tipos de estructuras que vamos a utilizar en losdiferentes ejemplos. Son declaraciones. Las estructuras se instancian luego en los programas. 
...
Gate_A20:
	...
	mov     al,WRITE_8042_OUT_PORT	;//Comando Write port del 8042..
